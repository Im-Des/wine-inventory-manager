...
router.get('/oauth2callback', passport.authenticate(
  'google',
  {
    successRedirect : '/wines', // UPDATE THIS, where do you want the client to go after you login 
    failureRedirect : '/wines' //  UPDATE THIS, where do you want the client to go if login fails
  }
));
